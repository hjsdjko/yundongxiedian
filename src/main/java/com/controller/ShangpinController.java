                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ShangpinEntity shangpinEntity = new ShangpinEntity();
//                            shangpinEntity.setShangpinUuidNumber(data.get(0));                    //产品编号 要改的
//                            shangpinEntity.setShangpinName(data.get(0));                    //产品名称 要改的
//                            shangpinEntity.setShangpinPhoto("");//详情和图片
//                            shangpinEntity.setShangpinTypes(Integer.valueOf(data.get(0)));   //产品类型 要改的
//                            shangpinEntity.setShangpinKucunNumber(Integer.valueOf(data.get(0)));   //产品库存 要改的
//                            shangpinEntity.setShangpinOldMoney(data.get(0));                    //产品原价 要改的
