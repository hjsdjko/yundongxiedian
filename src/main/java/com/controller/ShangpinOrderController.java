...
//                            shangpinOrderEntity.setShangpinId(Integer.valueOf(data.get(0)));   //产品 要改的
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : shangpins) {
           //取值
            ...
            shangpinOrderEntity.setShangpinId(shangpinId);//产品
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            shangpinService.updateById(shangpinEntity);//更新订单中产品的信息
            return R.ok();
    }
    ...
    public R deliver(Integer id ,String shangpinOrderCourierNumber, String shangpinOrderCourierName){
